#ifndef LC_PROT_LCFU___CANRECV__H
#define LC_PROT_LCFU___CANRECV__H
...
/*                            Typedefs                         */
typedef struct _LC_TD_FunctionBlock_CANRECV
{
...
} LCCG_StructAttrib LC_TD_FunctionBlock_CANRECV;

/*                   ColdBoot Initialization Macro             */
#define LC_INIT_FunctionBlock_CANRECV(p) \
{ \
...
#define LC_WINIT_FunctionBlock_CANRECV(p,RF) \
{ \
