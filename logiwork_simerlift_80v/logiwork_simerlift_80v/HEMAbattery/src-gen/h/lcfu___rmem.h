#ifndef LC_PROT_LCFU___RMEM__H
#define LC_PROT_LCFU___RMEM__H

#include <LC3CGBase.h>

/*                            Typedefs                         */
typedef struct _LC_TD_FunctionBlock_RMEM
{
  LC_TD_BOOL LC_VD_R;
...
} LCCG_StructAttrib LC_TD_FunctionBlock_RMEM;

/*                   ColdBoot Initialization Macro             */
#define LC_INIT_FunctionBlock_RMEM(p) \
{ \
...
#define LC_WINIT_FunctionBlock_RMEM(p,RF) \
{ \
...
/*                            Prototype                        */
void  lcfu___RMEM(LC_TD_FunctionBlock_RMEM* LC_this, struct _lcoplck_epdb_1_impl* pEPDB);
