#ifndef LC_PROT_LCFU___RBUF_DINT__H
#define LC_PROT_LCFU___RBUF_DINT__H

#include <LC3CGBase.h>

/*                            Typedefs                         */
typedef struct _LC_TD_FunctionBlock_RBUF_DINT
{
...
} LCCG_StructAttrib LC_TD_FunctionBlock_RBUF_DINT;

/*                   ColdBoot Initialization Macro             */
#define LC_INIT_FunctionBlock_RBUF_DINT(p) \
{ \
...
#define LC_WINIT_FunctionBlock_RBUF_DINT(p,RF) \
{ \
