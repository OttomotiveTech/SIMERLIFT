#ifndef LC_PROT_LCFU___FMEMW_REAL__H
#define LC_PROT_LCFU___FMEMW_REAL__H

#include <LC3CGBase.h>

/*                            Typedefs                         */
typedef struct _LC_TD_FunctionBlock_FMEMW_REAL
{
  LC_TD_BOOL LC_VD_R;
...
} LCCG_StructAttrib LC_TD_FunctionBlock_FMEMW_REAL;

/*                   ColdBoot Initialization Macro             */
#define LC_INIT_FunctionBlock_FMEMW_REAL(p) \
{ \
...
#define LC_WINIT_FunctionBlock_FMEMW_REAL(p,RF) \
{ \
...
/*                            Prototype                        */
void  lcfu___FMEMW_REAL(LC_TD_FunctionBlock_FMEMW_REAL* LC_this, struct _lcoplck_epdb_1_impl* pEPDB);
