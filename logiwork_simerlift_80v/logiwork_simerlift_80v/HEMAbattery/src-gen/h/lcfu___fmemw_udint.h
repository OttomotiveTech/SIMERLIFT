#ifndef LC_PROT_LCFU___FMEMW_UDINT__H
#define LC_PROT_LCFU___FMEMW_UDINT__H

#include <LC3CGBase.h>

/*                            Typedefs                         */
typedef struct _LC_TD_FunctionBlock_FMEMW_UDINT
{
  LC_TD_BOOL LC_VD_R;
  LC_TD_UDINT LC_VD_ADDR;
  LC_TD_UDINT LC_VD_VAL;
...
} LCCG_StructAttrib LC_TD_FunctionBlock_FMEMW_UDINT;

/*                   ColdBoot Initialization Macro             */
#define LC_INIT_FunctionBlock_FMEMW_UDINT(p) \
{ \
  LC_INIT_UDINT(&((p)->LC_VD_ADDR)); \
  LC_INIT_UDINT(&((p)->LC_VD_VAL)); \
...
#define LC_WINIT_FunctionBlock_FMEMW_UDINT(p,RF) \
{ \
  LC_WINIT_UDINT(&((p)->LC_VD_ADDR),RF); \
  LC_WINIT_UDINT(&((p)->LC_VD_VAL),RF); \
...
/*                            Prototype                        */
void  lcfu___FMEMW_UDINT(LC_TD_FunctionBlock_FMEMW_UDINT* LC_this, struct _lcoplck_epdb_1_impl* pEPDB);
