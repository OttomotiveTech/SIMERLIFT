#ifndef LC_PROT_LCFU___WMEM_SINT__H
#define LC_PROT_LCFU___WMEM_SINT__H

#include <LC3CGBase.h>

/*                            Typedefs                         */
typedef struct _LC_TD_FunctionBlock_WMEM_SINT
{
  LC_TD_BOOL LC_VD_R;
  LC_TD_SINT LC_VD_VAL;
...
} LCCG_StructAttrib LC_TD_FunctionBlock_WMEM_SINT;

/*                   ColdBoot Initialization Macro             */
#define LC_INIT_FunctionBlock_WMEM_SINT(p) \
{ \
  LC_INIT_UDINT(&((p)->LC_VD_ADDR)); \
  LC_INIT_SINT(&((p)->LC_VD_VAL)); \
...
#define LC_WINIT_FunctionBlock_WMEM_SINT(p,RF) \
{ \
  LC_WINIT_UDINT(&((p)->LC_VD_ADDR),RF); \
  LC_WINIT_SINT(&((p)->LC_VD_VAL),RF); \
...
/*                            Prototype                        */
void  lcfu___WMEM_SINT(LC_TD_FunctionBlock_WMEM_SINT* LC_this, struct _lcoplck_epdb_1_impl* pEPDB);
