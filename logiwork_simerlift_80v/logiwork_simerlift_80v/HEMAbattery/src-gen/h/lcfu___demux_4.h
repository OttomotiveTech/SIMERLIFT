#ifndef LC_PROT_LCFU___DEMUX_4__H
#define LC_PROT_LCFU___DEMUX_4__H
...
/*                            Typedefs                         */
typedef struct _LC_TD_FunctionBlock_DEMUX_4
{
...
} LCCG_StructAttrib LC_TD_FunctionBlock_DEMUX_4;

/*                   ColdBoot Initialization Macro             */
#define LC_INIT_FunctionBlock_DEMUX_4(p) \
{ \
...
#define LC_WINIT_FunctionBlock_DEMUX_4(p,RF) \
{ \
