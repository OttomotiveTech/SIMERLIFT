#ifndef LC_PROT_LCFU___RBUF_INT__H
#define LC_PROT_LCFU___RBUF_INT__H

#include <LC3CGBase.h>

/*                            Typedefs                         */
typedef struct _LC_TD_FunctionBlock_RBUF_INT
{
...
} LCCG_StructAttrib LC_TD_FunctionBlock_RBUF_INT;

/*                   ColdBoot Initialization Macro             */
#define LC_INIT_FunctionBlock_RBUF_INT(p) \
{ \
...
#define LC_WINIT_FunctionBlock_RBUF_INT(p,RF) \
{ \
