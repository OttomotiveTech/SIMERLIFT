#ifndef LC_PROT_LCFU___TBUFFER__C
#define LC_PROT_LCFU___TBUFFER__C
  ...
  {
    {
      ...
      LC_this->LC_VD_TON1.LC_VD_PT = LC_this->LC_VD_D;
    ...
    }
    {
      ...
      LC_this->LC_VD_TOF1.LC_VD_PT = LC_this->LC_VD_D;
