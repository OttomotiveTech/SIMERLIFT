#ifndef LC_PROT_LCFU___ESSBATTSTATE__C
#define LC_PROT_LCFU___ESSBATTSTATE__C
...
void  lcfu___ESSBATTSTATE(LC_TD_FunctionBlock_ESSBATTSTATE* LC_this, struct _lcoplck_epdb_1_impl* pEPDB)
{
  ...
  LC_this->LC_VD_PREVSTATE = LC_this->LC_VD_BATTERYSTATE;
  {
      ...
      }
      {
        ...
        else
        {
          ...
          else
          {
            {
              LC_TD_BOOL conditionResult = LC_EL_false;
              conditionResult = (lcfu_iec61131__AND__BOOL__2__INL((LC_TD_BOOL)(LC_this->LC_VD_PRECHARGEOK == LC_EL_true),(LC_TD_BOOL)(LC_this->LC_VD_CONTACTFBK == LC_EL_true)));
              if (conditionResult)
              {
                if (LC_this->LC_VD_CHARGERON)
                {
    ...
    else if ((caseSelector==LC_ED__BATTSTATE__SHUTDOWN))
    {
      ...
      {
        LC_TD_BOOL conditionResult = LC_EL_false;
        conditionResult = (lcfu_iec61131__OR__BOOL__2__INL(LC_this->LC_VD_BATSTATETIMEOUT,(lcfu_iec61131__AND__BOOL__2__INL(LC_this->LC_VD_SHUTDOWNCOMPLETE,(LC_TD_BOOL)(LC_this->LC_VD_BATSTATEELAPSEDTIME > LC_TIME_VALUE(RT_CC_CONST_LL(1),RT_CC_CONST_LL(0)))))));
        if (conditionResult)
        {
          LC_this->LC_VD_CONTACT = LC_EL_false;
          LC_this->LC_VD_CONTACTNEG = LC_EL_false;
          ...
          {
            if ((LC_TD_BOOL)(LC_this->LC_VD_BATSTATEELAPSEDTIME > LC_TIME_VALUE(RT_CC_CONST_LL(2),RT_CC_CONST_LL(500000000))))
            {
              LC_this->LC_VD_BATTERYSTATE = LC_ED__BATTSTATE__FAULT;
            }
          }
      ...
      {
        {
          ...
          else
          {
            {
              LC_TD_BOOL conditionResult = LC_EL_false;
              conditionResult = (lcfu_iec61131__AND__BOOL__2__INL((lcfu_iec61131__NOT__BOOL__INL(LC_this->LC_VD_OUTVOLTSTATUS)),LC_this->LC_VD_BATSTATETIMEOUT));
              if (conditionResult)
              {
                if (LC_this->LC_VD_UVFAULT)
                {
      ...
      {
        {
          ...
          else
          {
            {
              LC_TD_BOOL conditionResult = LC_EL_false;
              conditionResult = (lcfu_iec61131__AND__BOOL__2__INL(LC_this->LC_VD_OUTVOLTSTATUS,LC_this->LC_VD_BATSTATETIMEOUT));
              if (conditionResult)
              {
                if (LC_this->LC_VD_OVFAULT)
                {
