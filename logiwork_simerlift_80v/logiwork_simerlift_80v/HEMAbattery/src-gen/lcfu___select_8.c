#ifndef LC_PROT_LCFU___SELECT_8__C
#define LC_PROT_LCFU___SELECT_8__C

#include <lcfu___select_8.h>
...
void  lcfu___SELECT_8(LC_TD_FunctionBlock_SELECT_8* LC_this, struct _lcoplck_epdb_1_impl* pEPDB)
{
  /* Network 1 */
  {
    ...
    }
    {
      ...
      LC_INIT_Function_SEL_WORD(&lFunction_SEL_WORD);
      lFunction_SEL_WORD.LC_VD_ENO = LC_EL_true;
      lcfu_iec61131__SEL_WORD(&lFunction_SEL_WORD, LC_this->LC_VD_S4, LC_this->LC_VD___26_SEL_WORD, LC_this->LC_VD_IN4, pEPDB);
    ...
    }
    {
      ...
      LC_INIT_Function_SEL_WORD(&lFunction_SEL_WORD);
      lFunction_SEL_WORD.LC_VD_ENO = LC_EL_true;
      lcfu_iec61131__SEL_WORD(&lFunction_SEL_WORD, LC_this->LC_VD_S5, LC_this->LC_VD___25_SEL_WORD, LC_this->LC_VD_IN5, pEPDB);
    ...
    }
    {
      ...
      LC_INIT_Function_SEL_WORD(&lFunction_SEL_WORD);
      lFunction_SEL_WORD.LC_VD_ENO = LC_EL_true;
      lcfu_iec61131__SEL_WORD(&lFunction_SEL_WORD, LC_this->LC_VD_S6, LC_this->LC_VD___28_SEL_WORD, LC_this->LC_VD_IN6, pEPDB);
    ...
    }
    {
      ...
      LC_INIT_Function_SEL_WORD(&lFunction_SEL_WORD);
      lFunction_SEL_WORD.LC_VD_ENO = LC_EL_true;
      lcfu_iec61131__SEL_WORD(&lFunction_SEL_WORD, LC_this->LC_VD_S7, LC_this->LC_VD___27_SEL_WORD, LC_this->LC_VD_IN7, pEPDB);
