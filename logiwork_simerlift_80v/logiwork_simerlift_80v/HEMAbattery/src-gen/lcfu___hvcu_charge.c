#ifndef LC_PROT_LCFU___HVCU_CHARGE__C
#define LC_PROT_LCFU___HVCU_CHARGE__C
...
void  lcfu___HVCU_CHARGE(LC_TD_FunctionBlock_HVCU_CHARGE* LC_this, struct _lcoplck_epdb_1_impl* pEPDB)
{
  /* Network 1 */
  {
    ...
    }
    {
      ...
      LC_this->LC_VD_CHARGE_TARGET_CURRENT = lFunction_TO_UINT.LC_VD_TO_UINT;
    ...
    }
    {
      ...
      LC_this->LC_VD_CHARGE_TARGET_VOLTAGE = lFunction_TO_UINT.LC_VD_TO_UINT;
    ...
    }
    {
      ...
      LC_this->LC_VD_CHARGE_MAX_CURRENT = lFunction_TO_UINT.LC_VD_TO_UINT;
    ...
    }
    {
      ...
      LC_this->LC_VD_CHARGE_MAX_VOLTAGE = lFunction_TO_UINT.LC_VD_TO_UINT;
