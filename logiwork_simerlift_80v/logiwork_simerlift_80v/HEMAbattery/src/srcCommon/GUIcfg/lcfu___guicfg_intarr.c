#ifndef LC_PROT_LCFU___GUICFG_INTARR__C
#define LC_PROT_LCFU___GUICFG_INTARR__C
...
/* Vendor Code */
	...
	if( LC_this->LC_VD_R){
		...
		if( LC_this->LC_VD_BUF){
			len=ConfigRead( LC_this->LC_VD_CODE, CFGintArr, (void *)LC_this->LC_VD_BUF, (char *)CONFIGURATION_FLASH_BASE_ADDRESS, LC_this->LC_VD_MAX);
		}
