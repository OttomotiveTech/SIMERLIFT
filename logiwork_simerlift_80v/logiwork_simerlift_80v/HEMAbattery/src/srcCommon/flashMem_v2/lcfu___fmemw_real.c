#ifndef LC_PROT_LCFU___FMEMW_REAL__C
#define LC_PROT_LCFU___FMEMW_REAL__C
	    ...
	    case 0:
	    {
	        if( V(PENDING))
	        {
	            ...
	            if( V(ID)>0){
	                ...
	                flashTxMessage.data[0] = val32>>24;
	                flashTxMessage.data[1] = val32>>16;
	                flashTxMessage.data[2] = val32>>8;
	                flashTxMessage.data[3] = val32;
