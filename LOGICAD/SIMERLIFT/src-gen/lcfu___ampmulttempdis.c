#ifndef LC_PROT_LCFU___AMPMULTTEMPDIS__C
#define LC_PROT_LCFU___AMPMULTTEMPDIS__C
...
/*                            FunctionBlocks                   */
void  lcfu___AMPMULTTEMPDIS(LC_TD_FunctionBlock_AMPMULTTEMPDIS* LC_this, struct _lcoplck_epdb_1_impl* pEPDB)
{
  if ((LC_TD_BOOL)(LC_this->LC_VD_TEMP < (LC_TD_REAL)-30))
  {
  ...
  {
    if ((LC_TD_BOOL)(LC_this->LC_VD_TEMP < (LC_TD_REAL)-25))
    {
      LC_this->LC_VD_INSTANTMULT = (LC_TD_REAL)0.11;
    }
    else
    {
      ...
      else
      {
        ...
        else
        {
          ...
          {
            LC_this->LC_VD_INSTANTMULT = (LC_TD_REAL)0.25;
          }
          else
          {
            if ((LC_TD_BOOL)(LC_this->LC_VD_TEMP < (LC_TD_REAL)-5))
            {
              LC_this->LC_VD_INSTANTMULT = (LC_TD_REAL)0.3;
            }
            else
            {
