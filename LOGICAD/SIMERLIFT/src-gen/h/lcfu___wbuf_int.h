#ifndef LC_PROT_LCFU___WBUF_INT__H
#define LC_PROT_LCFU___WBUF_INT__H

#include <LC3CGBase.h>

/*                            Typedefs                         */
typedef struct _LC_TD_FunctionBlock_WBUF_INT
{
  LC_TD_INT LC_VD_PRM;
...
} LCCG_StructAttrib LC_TD_FunctionBlock_WBUF_INT;

/*                   ColdBoot Initialization Macro             */
#define LC_INIT_FunctionBlock_WBUF_INT(p) \
{ \
  LC_INIT_PTR(&((p)->LC_VD_BUF)); \
  LC_INIT_INT(&((p)->LC_VD_PRM)); \
  LC_INIT_PTR(&((p)->LC_VD_RET)); \
  LC_INIT_PTR(&((p)->LC_VD_NXT)); \
}

/*                   WarmBoot Initialization Macro             */
#define LC_WINIT_FunctionBlock_WBUF_INT(p,RF) \
{ \
  LC_WINIT_PTR(&((p)->LC_VD_BUF),RF); \
  LC_WINIT_INT(&((p)->LC_VD_PRM),RF); \
