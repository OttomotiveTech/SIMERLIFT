#ifndef LC_PROT_LCFU___AMPMULTTEMPDIS__H
#define LC_PROT_LCFU___AMPMULTTEMPDIS__H

#include <LC3CGBase.h>
#include <lcfu_iec61131__TON.h>

/*                            Typedefs                         */
typedef struct _LC_TD_FunctionBlock_AMPMULTTEMPDIS
{
...
} LCCG_StructAttrib LC_TD_FunctionBlock_AMPMULTTEMPDIS;

/*                   ColdBoot Initialization Macro             */
#define LC_INIT_FunctionBlock_AMPMULTTEMPDIS(p) \
{ \
...
#define LC_WINIT_FunctionBlock_AMPMULTTEMPDIS(p,RF) \
{ \
