#ifndef LC_PROT_LCFU___WMEM_REAL__H
#define LC_PROT_LCFU___WMEM_REAL__H

#include <LC3CGBase.h>

/*                            Typedefs                         */
typedef struct _LC_TD_FunctionBlock_WMEM_REAL
{
  LC_TD_BOOL LC_VD_R;
...
} LCCG_StructAttrib LC_TD_FunctionBlock_WMEM_REAL;

/*                   ColdBoot Initialization Macro             */
#define LC_INIT_FunctionBlock_WMEM_REAL(p) \
{ \
...
#define LC_WINIT_FunctionBlock_WMEM_REAL(p,RF) \
{ \
