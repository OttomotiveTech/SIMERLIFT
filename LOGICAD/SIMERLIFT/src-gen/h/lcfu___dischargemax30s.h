#ifndef LC_PROT_LCFU___DISCHARGEMAX30S__H
#define LC_PROT_LCFU___DISCHARGEMAX30S__H

#include <LC3CGBase.h>

/*                            Typedefs                         */
typedef struct _LC_TD_FunctionBlock_DISCHARGEMAX30S
{
  LC_TD_REAL LC_VD_SOC;
  LC_TD_REAL LC_VD_TEMP;
  LC_TD_BOOL LC_VD_ENO;
  LC_TD_REAL LC_VD_A;
} LCCG_StructAttrib LC_TD_FunctionBlock_DISCHARGEMAX30S;

/*                   ColdBoot Initialization Macro             */
#define LC_INIT_FunctionBlock_DISCHARGEMAX30S(p) \
{ \
...
#define LC_WINIT_FunctionBlock_DISCHARGEMAX30S(p,RF) \
{ \
