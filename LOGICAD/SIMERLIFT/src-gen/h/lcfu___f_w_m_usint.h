#ifndef LC_PROT_LCFU___F_W_M_USINT__H
#define LC_PROT_LCFU___F_W_M_USINT__H

#include <LC3CGBase.h>

/*                            Typedefs                         */
typedef struct _LC_TD_FunctionBlock_F_W_M_USINT
{
  LC_TD_BOOL LC_VD_R;
...
} LCCG_StructAttrib LC_TD_FunctionBlock_F_W_M_USINT;

/*                   ColdBoot Initialization Macro             */
#define LC_INIT_FunctionBlock_F_W_M_USINT(p) \
{ \
...
#define LC_WINIT_FunctionBlock_F_W_M_USINT(p,RF) \
{ \
