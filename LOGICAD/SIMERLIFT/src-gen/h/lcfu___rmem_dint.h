#ifndef LC_PROT_LCFU___RMEM_DINT__H
#define LC_PROT_LCFU___RMEM_DINT__H

#include <LC3CGBase.h>

/*                            Typedefs                         */
typedef struct _LC_TD_FunctionBlock_RMEM_DINT
{
  LC_TD_BOOL LC_VD_R;
...
} LCCG_StructAttrib LC_TD_FunctionBlock_RMEM_DINT;

/*                   ColdBoot Initialization Macro             */
#define LC_INIT_FunctionBlock_RMEM_DINT(p) \
{ \
...
#define LC_WINIT_FunctionBlock_RMEM_DINT(p,RF) \
{ \
