#ifndef LC_PROT_LCFU___GUICFG_HEXARR__H
#define LC_PROT_LCFU___GUICFG_HEXARR__H

#include <LC3CGBase.h>
#include <lcdt___guicfgcode.h>

/*                            Typedefs                         */
typedef struct _LC_TD_FunctionBlock_GUICFG_HEXARR
{
  LC_TD_BOOL LC_VD_R;
...
} LCCG_StructAttrib LC_TD_FunctionBlock_GUICFG_HEXARR;

/*                   ColdBoot Initialization Macro             */
#define LC_INIT_FunctionBlock_GUICFG_HEXARR(p) \
{ \
...
#define LC_WINIT_FunctionBlock_GUICFG_HEXARR(p,RF) \
{ \
