#ifndef LC_PROT_LCFU___WMEM_INT__H
#define LC_PROT_LCFU___WMEM_INT__H

#include <LC3CGBase.h>

/*                            Typedefs                         */
typedef struct _LC_TD_FunctionBlock_WMEM_INT
{
  LC_TD_BOOL LC_VD_R;
  LC_TD_INT LC_VD_VAL;
...
} LCCG_StructAttrib LC_TD_FunctionBlock_WMEM_INT;

/*                   ColdBoot Initialization Macro             */
#define LC_INIT_FunctionBlock_WMEM_INT(p) \
{ \
...
#define LC_WINIT_FunctionBlock_WMEM_INT(p,RF) \
{ \
