#ifndef LC_PROT_LCFU___REGENMAX__H
#define LC_PROT_LCFU___REGENMAX__H

#include <LC3CGBase.h>

/*                            Typedefs                         */
typedef struct _LC_TD_FunctionBlock_REGENMAX
{
  LC_TD_REAL LC_VD_SOC;
  LC_TD_REAL LC_VD_TEMP;
  LC_TD_BOOL LC_VD_ENO;
  LC_TD_REAL LC_VD_A;
} LCCG_StructAttrib LC_TD_FunctionBlock_REGENMAX;

/*                   ColdBoot Initialization Macro             */
#define LC_INIT_FunctionBlock_REGENMAX(p) \
{ \
...
#define LC_WINIT_FunctionBlock_REGENMAX(p,RF) \
{ \
