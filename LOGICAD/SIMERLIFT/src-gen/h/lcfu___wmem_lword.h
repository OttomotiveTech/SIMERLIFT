#ifndef LC_PROT_LCFU___WMEM_LWORD__H
#define LC_PROT_LCFU___WMEM_LWORD__H

#include <LC3CGBase.h>

/*                            Typedefs                         */
typedef struct _LC_TD_FunctionBlock_WMEM_LWORD
{
  LC_TD_BOOL LC_VD_R;
...
} LCCG_StructAttrib LC_TD_FunctionBlock_WMEM_LWORD;

/*                   ColdBoot Initialization Macro             */
#define LC_INIT_FunctionBlock_WMEM_LWORD(p) \
{ \
...
#define LC_WINIT_FunctionBlock_WMEM_LWORD(p,RF) \
{ \
...
/*                            Prototype                        */
void  lcfu___WMEM_LWORD(LC_TD_FunctionBlock_WMEM_LWORD* LC_this, struct _lcoplck_epdb_1_impl* pEPDB);
