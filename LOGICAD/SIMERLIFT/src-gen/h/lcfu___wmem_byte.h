#ifndef LC_PROT_LCFU___WMEM_BYTE__H
#define LC_PROT_LCFU___WMEM_BYTE__H

#include <LC3CGBase.h>

/*                            Typedefs                         */
typedef struct _LC_TD_FunctionBlock_WMEM_BYTE
{
  LC_TD_BOOL LC_VD_R;
...
} LCCG_StructAttrib LC_TD_FunctionBlock_WMEM_BYTE;

/*                   ColdBoot Initialization Macro             */
#define LC_INIT_FunctionBlock_WMEM_BYTE(p) \
{ \
...
#define LC_WINIT_FunctionBlock_WMEM_BYTE(p,RF) \
{ \
...
/*                            Prototype                        */
void  lcfu___WMEM_BYTE(LC_TD_FunctionBlock_WMEM_BYTE* LC_this, struct _lcoplck_epdb_1_impl* pEPDB);
