#ifndef LC_PROT_LCFU___WMEM_ULINT__H
#define LC_PROT_LCFU___WMEM_ULINT__H

#include <LC3CGBase.h>

/*                            Typedefs                         */
typedef struct _LC_TD_FunctionBlock_WMEM_ULINT
{
  LC_TD_BOOL LC_VD_R;
...
} LCCG_StructAttrib LC_TD_FunctionBlock_WMEM_ULINT;

/*                   ColdBoot Initialization Macro             */
#define LC_INIT_FunctionBlock_WMEM_ULINT(p) \
{ \
...
#define LC_WINIT_FunctionBlock_WMEM_ULINT(p,RF) \
{ \
...
/*                            Prototype                        */
void  lcfu___WMEM_ULINT(LC_TD_FunctionBlock_WMEM_ULINT* LC_this, struct _lcoplck_epdb_1_impl* pEPDB);
