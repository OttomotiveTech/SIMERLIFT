...
void  lcfu___ESSSTATE1(LC_TD_FunctionBlock_ESSSTATE1* LC_this, struct _lcoplck_epdb_1_impl* pEPDB)
{
  ...
  LC_this->LC_VD_PREVSTATE = LC_this->LC_VD_BATTERYSTATE;
  {
    ...
    if ((caseSelector==LC_ED__BATTSTATE__STANDBY))
    {
      ...
      LC_this->LC_VD_FAULTCOUNTER = (LC_TD_USINT)0;
    ...
    {
      {
        ...
        conditionResult = (lcfu_iec61131__AND__BOOL__2__INL(LC_this->LC_VD_PRECHARGEOK,LC_this->LC_VD_DISCHARGE));
        if (conditionResult)
        {
          LC_this->LC_VD_BATTERYSTATE = LC_ED__BATTSTATE__DISCHARGE;
        }
        else
        {
          {
            LC_TD_BOOL conditionResult = LC_EL_false;
            conditionResult = (lcfu_iec61131__AND__BOOL__2__INL(LC_this->LC_VD_DISCHARGE,(lcfu_iec61131__NOT__BOOL__INL(LC_this->LC_VD_PRECHARGEOK))));
            if (conditionResult)
            {
              LC_this->LC_VD_STATE = LC_ED__BATTSTATE__PRECHARGE;
              LC_this->LC_VD_CONTACT = LC_EL_false;
              LC_this->LC_VD_CONTACTNEG = LC_EL_false;
              LC_this->LC_VD_PRECHARGEON = LC_this->LC_VD_DISCHARGE;
              LC_this->LC_VD_FAULTCOUNTER = (LC_TD_USINT)0;
              {
                LC_this->LC_VD_CONTACTFBKTIMER.LC_VD_ENO = LC_EL_true;
                LC_this->LC_VD_CONTACTFBKTIMER.LC_VD_IN = LC_EL_true;
                LC_this->LC_VD_CONTACTFBKTIMER.LC_VD_PT = LC_TIME_VALUE(RT_CC_CONST_LL(5),RT_CC_CONST_LL(0));
              ...
              if (LC_this->LC_VD_CONTACTFBKTIMER.LC_VD_Q)
              {
                {
                  LC_TD_BOOL conditionResult = LC_EL_false;
                  conditionResult = (lcfu_iec61131__OR__BOOL__2__INL((lcfu_iec61131__OR__BOOL__2__INL(LC_this->LC_VD_FAULT,LC_this->LC_VD_SHUTDOWN)),LC_this->LC_VD_BATSTATETIMEOUT));
                  if (conditionResult)
                  {
                    LC_this->LC_VD_BATTERYSTATE = LC_ED__BATTSTATE__SHUTDOWN;
                  }
        ...
        {
          {
            ...
            if (conditionResult)
            {
              if ((LC_TD_BOOL)(LC_this->LC_VD_FAULTCOUNTER < (LC_TD_USINT)2))
              {
                LC_this->LC_VD_FAULTCOUNTER = (LC_TD_USINT)(LC_this->LC_VD_FAULTCOUNTER + (LC_TD_USINT)1);
              }
              else
              {
                LC_this->LC_VD_BATTERYSTATE = LC_ED__BATTSTATE__SHUTDOWN;
