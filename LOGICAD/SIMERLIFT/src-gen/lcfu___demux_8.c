#ifndef LC_PROT_LCFU___DEMUX_8__C
#define LC_PROT_LCFU___DEMUX_8__C
...
void  lcfu___DEMUX_8(LC_TD_FunctionBlock_DEMUX_8* LC_this, struct _lcoplck_epdb_1_impl* pEPDB)
{
  /* Network 1 */
  {
    ...
    }
    {
      ...
      LC_INIT_Function_EQ(&lFunction_EQ);
      lFunction_EQ.LC_VD_ENO = LC_EL_true;
      lcfu_iec61131__EQ__ANY__2(&lFunction_EQ, LC_this->LC_VD_SELECT, (LC_TD_BYTE)4, pEPDB);
      LC_this->LC_VD___24_EQ = lFunction_EQ.LC_VD_EQ;
    }
    {
      LC_TD_Function_SEL_UDINT lFunction_SEL_UDINT;
      LC_INIT_Function_SEL_UDINT(&lFunction_SEL_UDINT);
      lFunction_SEL_UDINT.LC_VD_ENO = LC_EL_true;
      lcfu_iec61131__SEL_UDINT(&lFunction_SEL_UDINT, LC_this->LC_VD___24_EQ, (LC_TD_UDINT)0UL, LC_this->LC_VD_IN, pEPDB);
      LC_this->LC_VD_OUT_4 = lFunction_SEL_UDINT.LC_VD_SEL_UDINT;
      LC_this->LC_VD___66_SEL_UDINT = lFunction_SEL_UDINT.LC_VD_SEL_UDINT;
    }
    {
      LC_TD_Function_EQ lFunction_EQ;
      LC_INIT_Function_EQ(&lFunction_EQ);
      lFunction_EQ.LC_VD_ENO = LC_EL_true;
      lcfu_iec61131__EQ__ANY__2(&lFunction_EQ, LC_this->LC_VD_SELECT, (LC_TD_BYTE)5, pEPDB);
      LC_this->LC_VD___27_EQ = lFunction_EQ.LC_VD_EQ;
    }
    {
      LC_TD_Function_SEL_UDINT lFunction_SEL_UDINT;
      LC_INIT_Function_SEL_UDINT(&lFunction_SEL_UDINT);
      lFunction_SEL_UDINT.LC_VD_ENO = LC_EL_true;
      lcfu_iec61131__SEL_UDINT(&lFunction_SEL_UDINT, LC_this->LC_VD___27_EQ, (LC_TD_UDINT)0UL, LC_this->LC_VD_IN, pEPDB);
      LC_this->LC_VD_OUT_5 = lFunction_SEL_UDINT.LC_VD_SEL_UDINT;
      LC_this->LC_VD___65_SEL_UDINT = lFunction_SEL_UDINT.LC_VD_SEL_UDINT;
    }
    {
      LC_TD_Function_EQ lFunction_EQ;
      LC_INIT_Function_EQ(&lFunction_EQ);
      lFunction_EQ.LC_VD_ENO = LC_EL_true;
      lcfu_iec61131__EQ__ANY__2(&lFunction_EQ, LC_this->LC_VD_SELECT, (LC_TD_BYTE)6, pEPDB);
      LC_this->LC_VD___30_EQ = lFunction_EQ.LC_VD_EQ;
    }
    {
      LC_TD_Function_SEL_UDINT lFunction_SEL_UDINT;
      LC_INIT_Function_SEL_UDINT(&lFunction_SEL_UDINT);
      lFunction_SEL_UDINT.LC_VD_ENO = LC_EL_true;
      lcfu_iec61131__SEL_UDINT(&lFunction_SEL_UDINT, LC_this->LC_VD___30_EQ, (LC_TD_UDINT)0UL, LC_this->LC_VD_IN, pEPDB);
      LC_this->LC_VD_OUT_6 = lFunction_SEL_UDINT.LC_VD_SEL_UDINT;
      LC_this->LC_VD___64_SEL_UDINT = lFunction_SEL_UDINT.LC_VD_SEL_UDINT;
    }
    {
      LC_TD_Function_EQ lFunction_EQ;
      LC_INIT_Function_EQ(&lFunction_EQ);
      lFunction_EQ.LC_VD_ENO = LC_EL_true;
      lcfu_iec61131__EQ__ANY__2(&lFunction_EQ, LC_this->LC_VD_SELECT, (LC_TD_BYTE)7, pEPDB);
      LC_this->LC_VD___33_EQ = lFunction_EQ.LC_VD_EQ;
    }
    {
      LC_TD_Function_SEL_UDINT lFunction_SEL_UDINT;
      LC_INIT_Function_SEL_UDINT(&lFunction_SEL_UDINT);
      lFunction_SEL_UDINT.LC_VD_ENO = LC_EL_true;
      lcfu_iec61131__SEL_UDINT(&lFunction_SEL_UDINT, LC_this->LC_VD___33_EQ, (LC_TD_UDINT)0UL, LC_this->LC_VD_IN, pEPDB);
      LC_this->LC_VD_OUT_7 = lFunction_SEL_UDINT.LC_VD_SEL_UDINT;
      LC_this->LC_VD___63_SEL_UDINT = lFunction_SEL_UDINT.LC_VD_SEL_UDINT;
    }
  }
}
