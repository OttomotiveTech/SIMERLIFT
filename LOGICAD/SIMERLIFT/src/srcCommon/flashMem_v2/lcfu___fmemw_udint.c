#ifndef LC_PROT_LCFU___FMEMW_UDINT__C
#define LC_PROT_LCFU___FMEMW_UDINT__C
    ...
    case 0:
    {
        if( V(PENDING))
        {
            ...
            if( V(ID)>0){
                ...
                flashTxMessage.data[0] = V(VAL)>>24;
                flashTxMessage.data[1] = V(VAL)>>16;
                flashTxMessage.data[2] = V(VAL)>>8;
                flashTxMessage.data[3] = V(VAL);
                flashTxMessage.dataSize = 4;
